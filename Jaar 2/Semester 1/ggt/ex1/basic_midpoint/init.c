...
void DrawFigure(SDL_Surface *screen) {
 ...
 for(i=0; i<32; i++) {
  ...
  //mla(screen, 200, 100, 100, 100, SDL_MapRGB(screen->format,0,0xFF,0));
  // mla(screen, 100, 100, 200, 90, SDL_MapRGB(screen->format,0xFF,0,0));
  // mla(screen, 100, 100, 200, 110, SDL_MapRGB(screen->format,0xFF,0xFF,0xFF));
  // mla(screen, 100, 100, 200, 192, SDL_MapRGB(screen->format,0xFF,0,0xFF));
  //
  // mla(screen, 200, 100, 100, 100, SDL_MapRGB(screen->format,0,0xFF,0));
  // mla(screen, 100, 100, 100, 200, SDL_MapRGB(screen->format,0,0xFF,0));
  // mla(screen, 200, 90, 100, 100, SDL_MapRGB(screen->format,0,0xFF,0));
  // mla(screen, 200, 110, 100, 100, SDL_MapRGB(screen->format,0,0xFF,0));
  // mla(screen, 200, 195, 150, 100, SDL_MapRGB(screen->format,0,0xFF,0));
